-- Helper function to get Mason package install path
local function get_mason_package_path(package_name)
  return vim.fn.stdpath('data') .. '/mason/packages/' .. package_name
end

local function get_jdtls()
  -- Get the full path to the directory where Mason has downloaded the JDTLS binaries
  ...
  if os_name == "Linux" then
    SYSTEM = arch == "aarch64" and "linux_arm" or "linux"
  elseif os_name == "Darwin" then
    SYSTEM = arch == "arm64" and "mac_arm" or "mac"
